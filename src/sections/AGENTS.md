...
- `Final.jsx` owns the final scroll-pinned video section and scrubs `/videos/output3.mp4`.
- `Outro.jsx` owns the closing coming-soon message and fades out the final video content.
